...
public class DummyAxonsFactoryImpl implements AxonsFactory {
	...
	@Override
	public AveragePoolingAxons createAveragePoolingAxons(Neurons3D leftNeurons, Neurons3D rightNeurons, int strideWidth,
			int strideHeight, int paddingWidth, int paddingHeight) {
	...
	public ConvolutionalAxons createConvolutionalAxons(Neurons3D leftNeurons, Neurons3D rightNeurons, int strideWidth,
		...
		return new DummyConvolutionalAxonsImpl(matrixFactory, leftNeurons, rightNeurons, strideWidth, strideHeight,
