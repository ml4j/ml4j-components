...
public class DefaultDifferentiableActivationFunctionActivationImplTest
	...
	protected DifferentiableActivationFunctionActivation createDifferentiableActivationFunctionActivationUnderTest(
		...
		return new DefaultDifferentiableActivationFunctionActivationImpl(activationFunction, input, output);
	}
