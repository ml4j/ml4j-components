...
public class DefaultDirectedAxonsComponentImplTest extends DirectedAxonsComponentTestBase {
	...
	public void testForwardPropagate() {
		...
		Mockito.when(mockAxonsActivation.getPostDropoutOutput()).thenReturn(mockNeuronsActivation);
		Mockito.when(mockAxons.pushLeftToRight(mockNeuronsActivation, null, mockAxonsContext)).thenReturn(mockAxonsActivation);
