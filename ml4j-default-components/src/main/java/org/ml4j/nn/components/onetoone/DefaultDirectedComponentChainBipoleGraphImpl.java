...
public class DefaultDirectedComponentChainBipoleGraphImpl extends DefaultDirectedComponentChainBipoleGraphBase
	...
	public DefaultDirectedComponentChainBipoleGraph dup() {
		return new DefaultDirectedComponentChainBipoleGraphImpl(inputNeurons, outputNeurons,
				parallelComponentChainsBatch.dup(), oneToManyDirectedComponent.dup(), manyToOneDirectedComponent.dup(),
				pathCombinationStrategy);
	}
	...
	public boolean isSupported(NeuronsActivationFormat<?> format) {
		return oneToManyDirectedComponent.isSupported(format)
				...
				&& parallelComponentChainsBatch.isSupported(format) && manyToOneDirectedComponent.isSupported(format);
	}
