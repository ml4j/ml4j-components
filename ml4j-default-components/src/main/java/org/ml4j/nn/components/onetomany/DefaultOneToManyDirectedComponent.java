 ...
 */
public class DefaultOneToManyDirectedComponent extends OneToManyDirectedComponentBase<OneToManyDirectedComponentActivation> implements OneToManyDirectedComponent<OneToManyDirectedComponentActivation> {

	private static final Logger LOGGER = LoggerFactory.getLogger(DefaultOneToManyDirectedComponent.class);
	 ...
	 */
	public DefaultOneToManyDirectedComponent(IntSupplier targetComponentsCountSupplier) {
		this.targetComponentsCountSupplier = targetComponentsCountSupplier;
	}

	@Override
	public OneToManyDirectedComponentActivation forwardPropagate(NeuronsActivation neuronsActivation,
		...
		return new DefaultOneToManyDirectedComponentActivation(context.getMatrixFactory(), neuronsActivation, targetComponentsCountSupplier.getAsInt());
	}

	@Override
	public DefaultOneToManyDirectedComponent dup() {
		int targetComponentsCountAtTimeOfDuplication = targetComponentsCountSupplier.getAsInt();
		return new DefaultOneToManyDirectedComponent(() -> targetComponentsCountAtTimeOfDuplication);
	}
}
