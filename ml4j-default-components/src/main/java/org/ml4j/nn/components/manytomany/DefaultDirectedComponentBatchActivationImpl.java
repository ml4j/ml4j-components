...
/**
 * Default implementation of an activation from a DefaultDirectedComponentBatch instance.
 * 
 * @author Michael Lavelle
 *
 */
public class DefaultDirectedComponentBatchActivationImpl extends DirectedComponentBatchActivationBase implements DefaultDirectedComponentBatchActivation{
	...
	private class ActivationGradientIndex {
		...
		public ActivationGradientIndex(DefaultChainableDirectedComponentActivation activation2, DirectedComponentGradient<NeuronsActivation> gradient, int index) {
