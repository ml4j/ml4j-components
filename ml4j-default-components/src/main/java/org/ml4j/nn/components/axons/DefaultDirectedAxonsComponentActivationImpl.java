...
public class DefaultDirectedAxonsComponentActivationImpl extends DirectedAxonsComponentActivationBase implements DirectedAxonsComponentActivation {
	...
	public DefaultDirectedAxonsComponentActivationImpl(AxonsContext axonsContext, DirectedAxonsComponent<?, ?> axonsComponent, AxonsActivation axonsActivation) {
	...
	public DirectedComponentGradient<NeuronsActivation> backPropagate(
		...
		LOGGER.debug("Back propagating gradient through DefaultDirectedAxonsComponentActivationImpl");
