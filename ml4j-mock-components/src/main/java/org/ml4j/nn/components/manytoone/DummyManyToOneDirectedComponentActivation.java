...
public class DummyManyToOneDirectedComponentActivation extends ManyToOneDirectedComponentActivationBase
	...
	public DirectedComponentGradient<List<NeuronsActivation>> backPropagate(
		...
		LOGGER.debug(
				"Mock back propagating single neurons activations into multiple back propagated neurons activations");
